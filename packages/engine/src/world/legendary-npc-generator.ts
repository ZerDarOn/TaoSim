...
const LEGENDARY_SEEDS: LegendaryNpcSeed[] = [
  {
    ...
    relations: {
      ...
      NPC_TIANJIAN_MASTER: { type: 'enemy', bond: -70, trust: 5, events: ['百年前两宗血战，结下死仇'] },
    },
  },
  {
    id: 'LEGEND_2',
  ...
  // ── 天剑宗（势力扩张与战争：第二宗门，正邪对峙）──
  {
    ...
    origin: { type: '宗门' },
    age: 150,
    spiritRoot: { grade: 'Heaven', elements: ['Metal'], isVariant: true },
    attributes: { physique: 28, comprehension: 26, perception: 28, agility: 24, luck: 22, charm: 18 },
    weaponElement: 'Metal',
    locationId: 'VENUE_TIANJIAN_HALL',
    factionId: 'FACT_TIANJIAN',
    socialRank: 'sectMaster',
    summary: '天剑宗宗主，以杀证道，剑下亡魂无数，与青云宗百年恩怨难解。',
    milestone: { year: -70, month: 8, title: '血屠之名，威震东荒' },
    relations: {
      LEGEND_1: { type: 'enemy', bond: -70, trust: 5, events: ['百年前两宗血战，结下死仇'] },
      NPC_TIANJIAN_ELDER: { type: 'master-disciple', bond: 40, trust: 55, events: ['收其为徒，授以杀伐剑道'], direction: 'master' },
    },
  },
  {
    ...
    age: 100,
    spiritRoot: { grade: 'Earth', elements: ['Metal'], isVariant: false },
    attributes: { physique: 26, comprehension: 24, perception: 26, agility: 28, luck: 20, charm: 16 },
    weaponElement: 'Metal',
    locationId: 'VENUE_TIANJIAN_HALL',
    factionId: 'FACT_TIANJIAN',
    socialRank: 'elder',
    summary: '天剑宗长老，剑走偏锋，出手狠辣，是宗主座下第一杀伐利器。',
    milestone: { year: -30, month: 5, title: '血衣之名，令散修闻风丧胆' },
    relations: {
      NPC_TIANJIAN_MASTER: { type: 'master-disciple', bond: 40, trust: 55, events: ['拜师血屠剑尊，习得杀伐剑道'], direction: 'disciple' },
    },
  },
];
