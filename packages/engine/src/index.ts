...
export { findActionableTargetLocationBelief, prepareNpcTargetTracking, resolveNpcTargetSearchAtLocation } from './world/npc-target-tracking.js';
...
export { advanceNpcRevengeAmbush } from './world/npc-revenge-ambush.js';
export type { NpcRevengeAmbushResult, NpcRevengeAmbushStage, NpcRevengeAmbushFailureReason } from './world/npc-revenge-ambush.js';
